...
Skycons.prototype = {
  ...
  add: function (el, draw) {
    ...
    const drawFunc = this._determineDrawingFunction(draw);
  ...
  set: function (el, color, draw = false) {
    if (color)
      this.color = color;
    ...
    for (let i = this.list.length; i--;)
      if (this.list[i].element === el) {
        if (draw) this.list[i].drawing = this._determineDrawingFunction(draw);
